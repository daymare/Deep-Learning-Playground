...
startEpsilon = 1
endEpsilon = 0.1
annealing_steps = 700000. # how many steps of training to reduce epsilon over
...
view_toggle = False
episode_view_delay = 100
print_delay = 1

load_model = True # whether to load a saved model
load_parameters = True # whether to load saved learning parameters
save_delay = 200 # how many episodes to wait between saves for the model
